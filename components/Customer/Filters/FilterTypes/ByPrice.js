      ...
      <Group noWrap>
        <Input
          ...
          onChange={(e) => {
            ...
            setPriceRange((prevPriceRange) => [e.target.value, prevPriceRange[1]]);
          }}
        />
        ...
        <Input
          ...
          onChange={(e) => {
            ...
            setPriceRange((prevPriceRange) => [prevPriceRange[0], e.target.value]);
          }}
        />
      </Group>
      <RangeSlider
        ...
        thumbSize={26}
        thumbChildren={[<ImLeaf size="1rem" key="1" />, <ImLeaf size="1rem" key="2" />]}
      />
    </Stack>
  );
};
